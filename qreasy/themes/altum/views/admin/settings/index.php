...
<div class="row">
    <div class="mb-5 mb-xl-0 col-12 col-xl-3">
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link" href="#stores" data-toggle="pill" role="tab"><i class="fa fa-fw fa-sm fa-store mr-1"></i> <?= $this->language->admin_settings->tab->stores ?></a>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="main">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted"><?= $this->language->admin_settings->main->default_timezone_help ?></small>
                            </div>
                        ...
                        <div class="tab-pane fade" id="stores">
                            <div class="">
                                <div class="form-group">
                                    <label><?= $this->language->admin_settings->stores->domains_is_enabled ?></label>

                                    <select name="stores_domains_is_enabled" class="form-control form-control-lg">
                                        <option value="1" <?= $this->settings->stores->domains_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->yes ?></option>
                                        <option value="0" <?= !$this->settings->stores->domains_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->no ?></option>
                                    </select>
                                    <small class="form-text text-muted"><?= $this->language->admin_settings->stores->domains_is_enabled_help ?></small>
                                </div>

                                <div class="form-group">
                                    <label><?= $this->language->admin_settings->stores->additional_domains_is_enabled ?></label>

                                    <select name="stores_additional_domains_is_enabled" class="form-control form-control-lg">
                                        <option value="1" <?= $this->settings->stores->additional_domains_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->yes ?></option>
                                        <option value="0" <?= !$this->settings->stores->additional_domains_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->no ?></option>
                                    </select>
                                    <small class="form-text text-muted"><?= $this->language->admin_settings->stores->additional_domains_is_enabled_help ?></small>
                                </div>

                                <div class="form-group">
                                    <label><?= $this->language->admin_settings->stores->main_domain_is_enabled ?></label>

                                    <select name="stores_main_domain_is_enabled" class="form-control form-control-lg">
                                        <option value="1" <?= $this->settings->stores->main_domain_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->yes ?></option>
                                        <option value="0" <?= !$this->settings->stores->main_domain_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->no ?></option>
                                    </select>
                                    <small class="form-text text-muted"><?= $this->language->admin_settings->stores->main_domain_is_enabled_help ?></small>
                                </div>
                            </div>

                            <div class="form-group">
                                <label><?= $this->language->admin_settings->stores->email_reports_is_enabled ?></label>

                                <select name="stores_email_reports_is_enabled" class="form-control form-control-lg">
                                    <option value="0" <?= !$this->settings->stores->email_reports_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->disabled ?></option>
                                    <option value="weekly" <?= $this->settings->stores->email_reports_is_enabled == 'weekly' ? 'selected="selected"' : null ?>><?= $this->language->admin_settings->stores->email_reports_is_enabled_weekly ?></option>
                                    <option value="monthly" <?= $this->settings->stores->email_reports_is_enabled == 'monthly' ? 'selected="selected"' : null ?>><?= $this->language->admin_settings->stores->email_reports_is_enabled_monthly ?></option>
                                </select>
                                <small class="form-text text-muted"><?= $this->language->admin_settings->stores->email_reports_is_enabled_help ?></small><br />
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="ads">
                            ...
                            <div class="form-group">
                                <label><?= $this->language->admin_settings->ads->header_restaurant ?></label>
                                <textarea class="form-control form-control-lg" name="ads_header_restaurant"><?= $this->settings->ads->header_restaurant ?></textarea>
                            </div>

                            <div class="form-group">
                                <label><?= $this->language->admin_settings->ads->footer_restaurant ?></label>
                                <textarea class="form-control form-control-lg" name="ads_footer_restaurant"><?= $this->settings->ads->footer_restaurant ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="captcha">
                            ...
                            <div class="form-group">
                                ...
                                <select name="captcha_recaptcha_is_enabled" class="form-control form-control-lg">
                                    <option value="1" <?= $this->settings->captcha->recaptcha_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->yes ?></option>
                                    <option value="0" <?= !$this->settings->captcha->recaptcha_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->no ?></option>
                                </select>

                                <small class="form-text text-muted"><?= $this->language->admin_settings->captcha->recaptcha_is_enabled_help ?></small>
                            </div>
                        ...
                        <div class="tab-pane fade" id="cron">
                            <input type="hidden" name="cron_reset_date" value="<?= $this->settings->cron->reset_date ?>" />
                            <input type="hidden" name="cron_key" value="<?= $this->settings->cron->key ?>" />
                        ...
                        <div class="mt-4">
                            ...
                            <input type="hidden" name="license_license" value="" />
                            <input type="hidden" name="license_type" value="" />
                            <input type="hidden" name="license_new_license" value="" />
                        </div>
                    </div>
                </form>
