...
class AdminSettings extends Controller {
    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            /* Stores Tab */
            $_POST['stores_email_reports_is_enabled'] = in_array($_POST['stores_email_reports_is_enabled'], [0, 'weekly', 'monthly']) ? $_POST['stores_email_reports_is_enabled'] : 0;
            $_POST['stores_domains_is_enabled'] = (bool) $_POST['stores_domains_is_enabled'];
            $_POST['stores_additional_domains_is_enabled'] = (bool) $_POST['stores_additional_domains_is_enabled'];
            $_POST['stores_main_domain_is_enabled'] = (bool) $_POST['stores_main_domain_is_enabled'];
            ...
            nulled: bypass this section
            */
            if(!empty($_POST['license_new_license']) && 1 == 2) {
                ...
                foreach($settings_keys as $key => $value) {
                    ...
                    if(is_array($value)) {
                        ...
                        foreach($value as $sub_key) {
                            ...
                            if(!in_array($key . '_' . $sub_key, ['custom_head_css', 'custom_head_js', 'ads_header', 'ads_footer', 'ads_header_restaurant', 'ads_footer_restaurant', 'offline_payment_instructions'])) {
